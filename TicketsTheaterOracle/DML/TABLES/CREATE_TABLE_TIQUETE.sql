...
(
    ...
    ESTADO VARCHAR2(20) DEFAULT 'PAGADO' CHECK (ESTADO IN ('PAGADO', 'RESERVADO', 'CANCELADO')),
    PELICULA_ID   INTEGER          NOT NULL,
    CLIENTE_DNI   NUMBER(12)       NOT NULL,
    CONSTRAINT PK_TIQUETE PRIMARY KEY (ID),
    CONSTRAINT FK_TIQUETE_PELICULA FOREIGN KEY (PELICULA_ID) REFERENCES PELICULA(ID),
